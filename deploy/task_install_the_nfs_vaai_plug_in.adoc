...
* Você deve ter baixado o pacote de instalação do NFS Plug-in for VAAI (``.vib` do site de suporte da NetApp. https://mysupport.netapp.com/site/global/dashboard["Suporte à NetApp"^]
